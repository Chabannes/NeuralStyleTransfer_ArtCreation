# Part of the code is due to the MatConvNet work and is used to load the parameters of the pretrained VGG19 model
...
class CONFIG:
    STYLE_IMAGE = 'Data/Van Gogh.jpg'
    CONTENT_IMAGE = 'Data/Paris.jpg'
    IMAGE_WIDTH = 600  # 400
    IMAGE_HEIGHT = 450  # 300
    COLOR_CHANNELS = 3
    NOISE_RATIO = 0.5
    ALPHA = 10  # content importance
    BETA = 50  # style importance
